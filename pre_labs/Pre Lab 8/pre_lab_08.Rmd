...
**Answer** The code is mutating the md_voters datafile to include the difference between 2024 and 2022. It is then selecting the top 10 counties in terms of difference and arranging them in descending order.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A plain white box?
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A grey bar chart.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It's now reordering by both county and difference, rather than just county. So it is in ascending order.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It adds coord_flip(). This makes it a horizontal bar chart. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It removes the grey background from the chart. I would assume this is via the theme_minimal() line of code. 
...
**Task** Run the following code. **Answer** Ran it.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** It changed the theme and background. It has a light blue, almost turquoise hue now. I would assume this comes from the theme_economist() line of code.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** This added a title to the chart and changed an axis name from count to county. It added a "title" line in the codeblock as well as a caption.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It is loading the data in order by date, and then providing the total contributions on those dates.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A chart with a bunch of swuiggly lines visualizing the data from the previous codeblock.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Makes the background of the chart have more and smaller grey boxes, because it adds exact dates (by day rather than month) to the x-axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It angles the dates at a 45 degree angle.
