...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It's now reordering by both county and difference, rather than just county.
