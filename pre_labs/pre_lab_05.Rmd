...
**Task** Load the five CSV files. Do they have the same column structure? **Answer** From what it looks like, no they do not. A few are slightly different.
...
**Task** Load the Maryland 2020 county population data **Answer** Not sure what the question is here.
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer** It is now showing counties with the highest percentage of 18+ asian population. Howard, Montgomery and Baltimore counties are the top three.
